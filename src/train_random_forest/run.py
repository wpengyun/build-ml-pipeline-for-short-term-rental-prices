...
def go(args):
    ...
    # YOUR CODE HERE
    ######################################
    logger.info("Upload model output artifact")
    artifact=wandb.Artifact(name=args.output_artifact,type="model_export",description="model artifact",metadata=rf_config)
